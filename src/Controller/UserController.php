...
class UserController
{
    ...
    { // utilise request pour l'accés au formulaire et App pour la connexion a la base de donnéé
    ...
    {// Fonction pour renvoie vers la page d'enregistrement 
        return $app['twig']->render('register.twig');
    }

    public function saveregisterAction(Request $request,Application $app)
    {// fonction pour s'enregistrer en tant qu'admin
      $app['dao.user']->RegisterAdmin($request);
